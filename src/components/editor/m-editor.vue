    ...
    <view class="page-body">
      <view class='wrapper'>
        <view class='toolbar' @tap="format">
          ...
          <view :class="formats.micon-previewarginBottom ? 'ql-active' : ''" class="iconfont icon-723bianjiqi_duanhouju" data-name="marginBottom" data-value="20px"></view>
        ...
        <editor id="editor" class="ql-container" placeholder="开始输入..." showImgSize showImgToolbar showImgResize @statuschange="onStatusChange" @input="onInput" :read-only="readOnly" @ready="onEditorReady">
        </editor>
      </view>
    </view>
  ...
  methods: {
    ...
    insertImage() {
      util.chooseImage(1).then(res => {
        let files = { filePath: res.tempFilePaths[0] };
